      ...
      <div className="h-auto md:h-[10vh] bg-[#dff7cc] px-[5%] md:px-[10%] py-6 md:py-0 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-0">
        ...
        <div className="bg-white px-[5%] md:px-[10%] py-20 flex flex-col items-center">
          <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex flex-col gap-6">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif leading-tight text-[#0f3d3a]">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col gap-8">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif leading-tight text-[#0f3d3a]">
              Transparent. <br />
              Collaborative. <br />
              Results-Driven.
            </h2>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white rounded-2xl p-8 flex gap-6">
              <span className="text-4xl font-serif text-[#0f3d3a]">01</span>
              <div>
                <h4 className="text-lg font-semibold text-[#0f3d3a]">
                  Discovery & Strategy
                </h4>
            ...
            <div className="rounded-2xl p-8 flex gap-6">
              <span className="text-4xl font-serif text-[#0f3d3a]">02</span>
              <div>
                <h4 className="text-lg font-semibold text-[#0f3d3a]">
                  Planning
                </h4>
            ...
            <div className="bg-white rounded-2xl p-8 flex gap-6">
              <span className="text-4xl font-serif text-[#0f3d3a]">03</span>
              <div>
                <h4 className="text-lg font-semibold text-[#0f3d3a]">
            ...
            <div className="rounded-2xl p-8 flex gap-6">
              <span className="text-4xl font-serif text-[#0f3d3a]">04</span>
              <div>
                <h4 className="text-lg font-semibold text-[#0f3d3a]">
        ...
        <section className="relative w-full min-h-[420px] overflow-hidden bg-[#0f2f2a] text-white">
        <div className="absolute inset-0">
          <div className="absolute -left-30 -top-18 h-full w-[60%] -rotate-40 bg-[#1f4d45] opacity-60" />
          <div className="absolute right-[-40%] -top-20 h-full w-[60%] -rotate-40 bg-[#163f38] opacity-70" />
        </div>
