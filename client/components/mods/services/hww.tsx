        ...
        <div className="w-full bg-[#f7f7f7] px-[5%] md:px-[10%] py-20">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="bg-white rounded-2xl p-4 flex gap-6">
                        <span className="text-3xl font-sans text-[#234F72]">01</span>
                        <div>
                    ...
                    <div className="rounded-2xl p-4 flex gap-6">
                        <span className="text-3xl font-sans text-[#234F72]">02</span>
                        <div>
                            <h4 className="text-lg font-semibold text-[#234F72]">
                    ...
                    <div className="bg-white rounded-2xl p-4 flex gap-6">
                        <span className="text-3xl font-sans text-[#234F72]">03</span>
                        <div>
                            <h4 className="text-lg font-semibold text-[#234F72]">
                                {t("lines.third.title")}
                            </h4>
                    ...
                    <div className="rounded-2xl p-4 flex gap-6">
                        <span className="text-3xl font-sans text-[#234F72]">04</span>
                        <div>
                            <h4 className="text-lg font-semibold text-[#234F72]">
                    ...
                    <div className="bg-white rounded-2xl p-4 flex gap-6">
                        <span className="text-3xl font-sans text-[#234F72]">05</span>
                        <div>
                            <h4 className="text-lg font-semibold text-[#234F72]">
                                {t("lines.fifth.title")}
                            </h4>
                            <p className="text-gray-600 text-sm mt-1">
                                {t("lines.fifth.description")}
                            </p>
                        </div>
                    </div>
                </div>
