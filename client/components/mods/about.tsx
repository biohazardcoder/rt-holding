    ...
    return (
        <div className="bg-[#f7f7f7] grid grid-cols-1 md:grid-cols-4 px-4 md:px-[10%] gap-8 py-8 md:py-16">
                <div>
                        ...
                        <p className="mt-4 text-2xl">Securing Your <br /> Financial Legacy</p>
                </div>
                <div className="col-span-1 md:col-span-3">
                        ...
                        <div className="mt-4 flex flex-col md:flex-row items-center gap-4">
                                <Button className="bg-transparent text-[#0f3d3a] font-semibold border border-[#0f3d3a] hover:bg-[#0f3d3a] rounded-[3px] hover:text-white cursor-pointer w-full md:w-auto">
